...
#
# Script generated by Vivado on Fri Mar 28 07:38:02 +0100 2025
# SW Build 3865809 on Sun May  7 15:05:29 MDT 2023
#
# Tool Version Limit: 2023.05 
#
# Filename     : tangerineNX_Z7.sh
...
#
# Usage        : tangerineNX_Z7.sh
#                tangerineNX_Z7.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                tangerineNX_Z7.sh [-reset_run]
#                tangerineNX_Z7.sh [-reset_log]
#                tangerineNX_Z7.sh [-help]
#
...
#                script (type 'tangerineNX_Z7.sh -help' for more information).
#
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./tangerineNX_Z7.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.tangerineNX_Z7 xil_defaultlib.glbl -o tangerineNX_Z7_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./tangerineNX_Z7_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key tangerineNX_Z7_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc tangerineNX_Z7_simv.daidir vcs_lib c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./tangerineNX_Z7.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: tangerineNX_Z7.sh [-help]\n\
Usage: tangerineNX_Z7.sh [-step]\n\
Usage: tangerineNX_Z7.sh [-lib_map_path]\n\
Usage: tangerineNX_Z7.sh [-reset_run]\n\
Usage: tangerineNX_Z7.sh [-reset_log]\n\
Usage: tangerineNX_Z7.sh [-keep_index]\n\
Usage: tangerineNX_Z7.sh [-noclean_files]\n\n\
