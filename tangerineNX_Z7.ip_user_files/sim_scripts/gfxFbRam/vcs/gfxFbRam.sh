...
#
# Script generated by Vivado on Thu Apr 03 16:06:20 +0200 2025
# SW Build 3865809 on Sun May  7 15:05:29 MDT 2023
#
# Tool Version Limit: 2023.05 
#
# Filename     : gfxFbRam.sh
...
#
# Usage        : gfxFbRam.sh
#                gfxFbRam.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                gfxFbRam.sh [-reset_run]
#                gfxFbRam.sh [-reset_log]
#                gfxFbRam.sh [-help]
#
...
#                script (type 'gfxFbRam.sh -help' for more information).
#
...
# script info
echo -e "gfxFbRam.sh - Script generated by export_simulation (Vivado v2023.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./gfxFbRam.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.gfxFbRam xil_defaultlib.glbl -o gfxFbRam_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./gfxFbRam_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key gfxFbRam_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc gfxFbRam_simv.daidir vcs_lib c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./gfxFbRam.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: gfxFbRam.sh [-help]\n\
Usage: gfxFbRam.sh [-step]\n\
Usage: gfxFbRam.sh [-lib_map_path]\n\
Usage: gfxFbRam.sh [-reset_run]\n\
Usage: gfxFbRam.sh [-reset_log]\n\
Usage: gfxFbRam.sh [-keep_index]\n\
Usage: gfxFbRam.sh [-noclean_files]\n\n\
