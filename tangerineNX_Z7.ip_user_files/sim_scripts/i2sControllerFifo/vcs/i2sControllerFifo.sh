...
#
# Script generated by Vivado on Sun Apr 06 11:53:51 +0200 2025
# SW Build 3865809 on Sun May  7 15:05:29 MDT 2023
#
# Tool Version Limit: 2023.05 
#
# Filename     : i2sControllerFifo.sh
...
#
# Usage        : i2sControllerFifo.sh
#                i2sControllerFifo.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                i2sControllerFifo.sh [-reset_run]
#                i2sControllerFifo.sh [-reset_log]
#                i2sControllerFifo.sh [-help]
#
...
#                script (type 'i2sControllerFifo.sh -help' for more information).
#
...
# script info
echo -e "i2sControllerFifo.sh - Script generated by export_simulation (Vivado v2023.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./i2sControllerFifo.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
compile()
{
  vlogan -work xilinx_vip $vlogan_opts -sverilog +incdir+"D:/Xilinx2023.1/Vivado/2023.1/data/xilinx_vip/include" \
  ...
  vlogan -work xpm $vlogan_opts -sverilog +incdir+"D:/Xilinx2023.1/Vivado/2023.1/data/xilinx_vip/include" \
  ...
  vlogan -work fifo_generator_v13_2_8 $vlogan_opts +v2k +incdir+"D:/Xilinx2023.1/Vivado/2023.1/data/xilinx_vip/include" \
  ...
  vlogan -work xil_defaultlib $vlogan_opts +v2k +incdir+"D:/Xilinx2023.1/Vivado/2023.1/data/xilinx_vip/include" \
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.i2sControllerFifo xil_defaultlib.glbl -o i2sControllerFifo_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./i2sControllerFifo_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key i2sControllerFifo_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc i2sControllerFifo_simv.daidir vcs_lib c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./i2sControllerFifo.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: i2sControllerFifo.sh [-help]\n\
Usage: i2sControllerFifo.sh [-step]\n\
Usage: i2sControllerFifo.sh [-lib_map_path]\n\
Usage: i2sControllerFifo.sh [-reset_run]\n\
Usage: i2sControllerFifo.sh [-reset_log]\n\
Usage: i2sControllerFifo.sh [-keep_index]\n\
Usage: i2sControllerFifo.sh [-noclean_files]\n\n\
