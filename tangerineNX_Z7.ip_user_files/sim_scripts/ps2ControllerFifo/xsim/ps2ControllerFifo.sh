...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L fifo_generator_v13_2_8 -L xil_defaultlib -L xilinx_vip -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot ps2ControllerFifo xil_defaultlib.ps2ControllerFifo xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim ps2ControllerFifo -key {Behavioral:sim_1:Functional:ps2ControllerFifo} -tclbatch cmd.tcl -protoinst "protoinst_files/tangerineNX_Z7.protoinst" -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb ps2ControllerFifo.wdb xsim.dir libdpi.so)
