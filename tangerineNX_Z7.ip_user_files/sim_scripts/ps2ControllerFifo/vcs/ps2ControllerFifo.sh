...
#
# Script generated by Vivado on Sat Mar 29 09:18:47 +0100 2025
# SW Build 3865809 on Sun May  7 15:05:29 MDT 2023
#
# Tool Version Limit: 2023.05 
#
# Filename     : ps2ControllerFifo.sh
...
#
# Usage        : ps2ControllerFifo.sh
#                ps2ControllerFifo.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                ps2ControllerFifo.sh [-reset_run]
#                ps2ControllerFifo.sh [-reset_log]
#                ps2ControllerFifo.sh [-help]
#
...
#                script (type 'ps2ControllerFifo.sh -help' for more information).
#
...
# script info
echo -e "ps2ControllerFifo.sh - Script generated by export_simulation (Vivado v2023.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./ps2ControllerFifo.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.ps2ControllerFifo xil_defaultlib.glbl -o ps2ControllerFifo_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./ps2ControllerFifo_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key ps2ControllerFifo_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc ps2ControllerFifo_simv.daidir vcs_lib c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./ps2ControllerFifo.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: ps2ControllerFifo.sh [-help]\n\
Usage: ps2ControllerFifo.sh [-step]\n\
Usage: ps2ControllerFifo.sh [-lib_map_path]\n\
Usage: ps2ControllerFifo.sh [-reset_run]\n\
Usage: ps2ControllerFifo.sh [-reset_log]\n\
Usage: ps2ControllerFifo.sh [-keep_index]\n\
Usage: ps2ControllerFifo.sh [-noclean_files]\n\n\
