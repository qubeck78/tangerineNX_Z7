...
compile()
{
  ...
  xmvlog -work blk_mem_gen_v8_4_6 $xmvlog_opts +incdir+"D:/Xilinx2023.1/Vivado/2023.1/data/xilinx_vip/include" \
...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.fontPROM xil_defaultlib.glbl
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.fontPROM -input simulate.do
}
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log fontPROM_sc.so .tmp_log xcelium_lib waves.shm c.obj)
