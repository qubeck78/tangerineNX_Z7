...
#
# Script generated by Vivado on Fri Mar 28 17:54:20 +0100 2025
# SW Build 3865809 on Sun May  7 15:05:29 MDT 2023
#
# Tool Version Limit: 2023.05 
#
# Filename     : fontPROM.sh
...
#
# Usage        : fontPROM.sh
#                fontPROM.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                fontPROM.sh [-reset_run]
#                fontPROM.sh [-reset_log]
#                fontPROM.sh [-help]
#
...
#                script (type 'fontPROM.sh -help' for more information).
#
...
# script info
echo -e "fontPROM.sh - Script generated by export_simulation (Vivado v2023.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./fontPROM.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
compile()
{
  ...
  vlogan -work blk_mem_gen_v8_4_6 $vlogan_opts +v2k +incdir+"D:/Xilinx2023.1/Vivado/2023.1/data/xilinx_vip/include" \
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.fontPROM xil_defaultlib.glbl -o fontPROM_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./fontPROM_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key fontPROM_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc fontPROM_simv.daidir vcs_lib c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./fontPROM.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: fontPROM.sh [-help]\n\
Usage: fontPROM.sh [-step]\n\
Usage: fontPROM.sh [-lib_map_path]\n\
Usage: fontPROM.sh [-reset_run]\n\
Usage: fontPROM.sh [-reset_log]\n\
Usage: fontPROM.sh [-keep_index]\n\
Usage: fontPROM.sh [-noclean_files]\n\n\
